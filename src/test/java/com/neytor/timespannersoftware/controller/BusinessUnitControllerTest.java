...
public class BusinessUnitControllerTest {
    ...
    @Autowired
    public BusinessUnitControllerTest(MockMvc mockMvc, BusinessUnitController controller) {
    ...
    void findAll() throws Exception{
        // given
        BusinessUnitEntity entity1 = new BusinessUnitEntity();
        BusinessUnitEntity entity2 = new BusinessUnitEntity();
        List entities = Arrays.asList(entity1,entity2);

        given(service.findAll()).willReturn(entities);

        // when
        ResponseEntity<List<BusinessUnit>> responseEntity = controller.findAll();
    ...
    void finById() throws Exception{
        BusinessUnitEntity entity1 = new BusinessUnitEntity(1L,"codigo","descripcion" );
        given(service.findById(2L)).willReturn(Optional.of(entity1));

        ResponseEntity<BusinessUnit> responseEntity = controller.finById(2L);
    ...
    void findByDescription() throws Exception{
        BusinessUnitEntity entity1 = new BusinessUnitEntity(1L,"codigo1","descripcion1" );
        BusinessUnitEntity entity2 = new BusinessUnitEntity(2L,"codigo2","descripcion2" );
        List entities = Arrays.asList(entity1,entity2);
        given(service.findByDescriptionContaining("descripcion")).willReturn(entities);

        ResponseEntity<List<BusinessUnit>> response = (controller.findByDescription("descripcion"));
    ...
    void create() throws Exception{
        BusinessUnitEntity entity1 = new BusinessUnitEntity(1L,"codigo1","descripcion1" );
        given(service.create(any(BusinessUnitEntity.class))).willReturn(entity1);
    ...
    void update() throws Exception {
        BusinessUnitEntity entity1 = new BusinessUnitEntity(1L,"codigo1","descripcion1" );
        BusinessUnit businessUnitDto = new BusinessUnit(1L,"codigo1","descripcion1" );
        given(service.findById(1L)).willReturn(Optional.of(entity1));
        given(service.update(entity1)).willReturn(entity1);

        ResponseEntity<BusinessUnit> responseEntity = controller.update(businessUnitDto);
